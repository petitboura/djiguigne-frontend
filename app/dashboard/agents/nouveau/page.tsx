...
function FormulaireCreerAgent() {
  ...
  // Bourama, suite à un agent test retrouvé avec les 6 remplies en même
  // temps -- rien ne l'empêchait avant). Chaque onChange ci-dessous vide
  // les 5 autres dès qu'on tape dans l'un ; ceci désactive visuellement
  // les autres champs tant qu'un est rempli.
          ...
          <section className="flex flex-col gap-4 rounded-2xl border border-dj-bordure bg-dj-surface p-6">
            ...
            <div className="flex flex-col gap-4 rounded-xl border border-dj-bordure p-4">
              ...
              <p className="-mt-2 text-xs text-dj-texte-muet">
                ...
                Une seule catégorie à la fois par agent (demande de Bourama,
                02/08, suite à un agent test retrouvé avec les 6 remplies en
                même temps) : en choisir une vide et désactive les autres.
              </p>
